...
string ChooseGroupbyTile(object oArea) 
{
  ...
  if ((FindSubString(aname, "forest") != -1) ||
    ...
    case 7: group = "scaled_kobolds"; break;
    case 8: group = "forest"; break;
    }
    return group;
  }
  ...
  if ((FindSubString(aname, "road") != -1) ||
      ...
      (FindSubString(aname, "way") != -1))
    {
      switch(Random(6) + 1)
        ...
        case 5: group = "goblins_low"; break;
        case 6: group = "cr_militia"; break;
        }
      return group;
    } 
  ...
  if ( (FindSubString(aname, "peak") != -1) ||
       ...
       (FindSubString(aname, "valley") != -1))
    {
      switch(Random(9) + 1)
        {
        case 1: group = "scaled_ogres"; break;
        case 2: group = "scaled_drows"; break;
        case 3: group = "scaled_rxvars"; break;
        case 4: group = "scaled_giants"; break;
        case 5: group = "scaled_mercs"; break;
        case 6: group = "scaled_kobolds"; break;
        case 7: group = "kobolds"; break;
        case 8: group = "scaled_gobs"; break;
        case 9: group = "gobs"; break;
        default: group = "scaled_gobs"; break;
        }
      return group;
    }    
