...
string s1st_PCGetVarName(object oPC)
{
  ...
  for (i=0;i<nCharName;i++)  //Search through each letter of the name. Add only if it's legal. => Ricerca attraverso ogni lettera del nome. Aggiunga soltanto se � legale.
   {
...
/* This variable should be set on the animal if it differs from Tame.
  ...
  Un valore di 1 significa che il cavallo non risponder�. Questo valore � conservato per tutta
  la crudelt� che il pc infligge su esso e non � usato come reazione iniziale. Inoltre un valore di 10 mezzi
  il cavallo allineare ama il pc, che inoltre � riservato agli atti di bont�.
*/
}
