...
//::////////////////////////////////////////////////////////
/*
     Added to HCR 3.03 base module - 26th January, 2006 - SE
*/
//::////////////////////////////////////////////////////////
...
void GZRemovePhysicalDamage(object oPC)
{
    int heal = d8(3)+10; //Cure serious Wounds
...
// This function sets the cost of Dom Queron's custom healer services
void GZSetUpHealer(object oModule)
{
    if (GetLocalInt(oModule,"T1_MODULE_HEALERSETUP") == 0)
    {
        SetLocalInt(oModule,"T1_MODULE_HEALER_FULLCHECK",250);
        SetLocalInt(oModule,"T1_MODULE_HEALER_HEAL",20);
        SetLocalInt(oModule,"T1_MODULE_HEALER_RESLVL",80);
        SetLocalInt(oModule,"T1_MODULE_HEALER_RESAB",80);
        SetLocalInt(oModule,"T1_MODULE_HEALER_DISEASE",40);
        SetLocalInt(oModule,"T1_MODULE_HEALER_BLIND",40);
        SetLocalInt(oModule,"T1_MODULE_HEALER_POISON",40);
        SetLocalInt(oModule,"T1_MODULE_HEALER_CURSE",40);
