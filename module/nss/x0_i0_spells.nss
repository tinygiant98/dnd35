...
//::
//:: HCR v3.4.0 - Re-Added fix for DoPetrification spawning GUI panel w/Death Sys.
//:: 21st July, 2008
//:://////////////////////////////////////////////
            ...
            if (!MySavingThrow(SAVING_THROW_FORT, oTarget, nSaveDC))
            {
                ...
                if (bIsPC == TRUE)
                {
                    if (bShowPopup == TRUE)
                    {
                        ...
                        // HCR 3.0 - Took out respawn panel if Death System is on.
                        if (!GetLocalInt(GetModule(), "DEATHSYSTEM"))
